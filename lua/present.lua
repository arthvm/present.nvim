...
local create_window_configurations = function()
	...
	local footer_height = 1 + 0 -- 1 + border
	local body_height = height - header_height - footer_height - 2 - 1 -- for border and padding
...
M.start_presentation = function(opts)
	...
	present_keymap("n", "X", function()
		...
		-- TODO: Add code execution for other languages
	...
	-- This is kinda cool
	-- Basically setting the options of the user and the options we want for presentation
	...
	vim.api.nvim_create_autocmd("BufLeave", {
		buffer = state.floats.body.buf,
		callback = function()
			-- Here we reset the options back to the original
			for option, config in pairs(restore) do
...
-- M.start_presentation({ bufnr = 127 })
